...
class Speaker():
    ...
    def train(self, iters, idx):
        l = 0

        if idx >=25000:
            # print("FLAG VALUE IS", self.decoder.embedding.weight.requires_grad)
            self.decoder.embedding.weight.requires_grad = True
            print("Unfreezing the weights before they converge", self.decoder.embedding.weight.requires_grad)
        ...
        # print(self.decoder.embedding.weight.item())
        return l / iters
